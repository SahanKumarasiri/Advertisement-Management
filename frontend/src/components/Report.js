...
export default class Report extends Component {
  ...
  componentDidMount() {
    axios.get("http://localhost:8070/advertise/").then((response) => {
      ...
      <div>
        <TableContainer id="pdfdiv" className="txt" component={Paper}>
          <Table stickyHeader aria-label="sticky table">
            <TableHead>
              <TableRow>
                <TableCell align="right">Adverisement Name</TableCell>
            ...
            <TableBody>
              {this.state?.ReportData?.map((p, index) => {
                return (
                  <TableRow key={index}>
                    <TableCell align="right">{p.adName}</TableCell>
                    ...
                    <TableCell align="right">+94 {p.description}</TableCell>
                    <TableCell align="right">{p.priceRange}</TableCell>
                  </TableRow>
                );
              })}
            </TableBody>
        ...
        <center>
          ...
          <span style={{ color: "lightcoral" }}>ABC Company</span>
